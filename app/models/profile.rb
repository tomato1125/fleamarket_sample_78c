class Profile < ApplicationRecord
  ...
  validates :family_name, presence: true, format:{with: VALID_NAME,message:"は全角で入力してください"}
  validates :first_name, presence: true, format:{with: VALID_NAME,message:"は全角で入力してください"}
  validates :family_name_kana, presence: true, format:{with: VALID_NAME_KANA, message:"は全角カタカナで入力してください"}
