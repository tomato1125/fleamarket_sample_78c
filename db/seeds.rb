...
# # ベビー・キッズ
# baby_kids = Itemcategory.create(name: "ベビー・キッズ")
...
# # インテリア・住まい・小物
# interior_residence_accessory = Itemcategory.create(name: "インテリア・住まい・小物")
...
# # 本・音楽・ゲーム
# book_music_game = Itemcategory.create(name: "本・音楽・ゲーム")
...
# # おもちゃ・ホビー・グッズ
# toy_hobby_goods = Itemcategory.create(name: "おもちゃ・ホビー・グッズ")
...
# # コスメ・香水・美容
# cosme_perfume_beauty = Itemcategory.create(name: "コスメ・香水・美容")
...
# # 家電・スマホ・カメラ
# appliance_smartphone_camera = Itemcategory.create(name: "家電・スマホ・カメラ")
...
# # スポーツ・レジャー
# sport_leisure = Itemcategory.create(name: "スポーツ・レジャー")
...
# # ハンドメイド
# handmade = Itemcategory.create(name: "ハンドメイド")
...
# # チケット
# ticket = Itemcategory.create(name: "チケット")
...
# # 自動車・オートバイ
# car_motorcycle = Itemcategory.create(name: "自動車・オートバイ")
...
# # その他
# others = Itemcategory.create(name: "その他")
