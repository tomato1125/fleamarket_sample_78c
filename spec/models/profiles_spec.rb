...
describe Profile do
  describe '#create' do
    ...
    it "is invalid without a wrong hiragana" do
      ...
      profile.valid?
      expect(profile.errors[:family_name]).to include("を全角ひらがなで入力してください。")
    end
    ...
    it "is invalid without a wrong hiragana" do
      ...
      profile.valid?
      expect(profile.errors[:first_name]).to include("を全角ひらがなで入力してください。")
    end
    ...
    it "is invalid without a wrong katakana" do
      ...
      profile.valid?
      expect(profile.errors[:family_name_kana]).to include("を全角カタカナで入力してください。")
    end
    ...
    it "is invalid without a wrong katakana" do
      ...
      profile.valid?
      expect(profile.errors[:first_name_kana]).to include("を全角カタカナで入力してください。")
    end
