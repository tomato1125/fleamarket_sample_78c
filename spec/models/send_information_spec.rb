...
describe SendInformation do
  describe '#create' do
    ...
    it "is invalid without a family_name" do
      ...
      expect(send_information.errors[:family_name]).to include("を入力してください")
    end

    it "is invalid without a first_name" do
      send_information = build(:send_information, first_name: "")
      send_information.valid?
      expect(send_information.errors[:first_name]).to include("を入力してください")
    end

    it "is invalid without a family_name_kana" do
      send_information = build(:send_information, family_name_kana: "")
      send_information.valid?
      expect(send_information.errors[:family_name_kana]).to include("を入力してください")
    end

    it "is invalid without a first_name_kana" do
      send_information = build(:send_information, first_name_kana: "")
      send_information.valid?
      expect(send_information.errors[:first_name_kana]).to include("を入力してください")
    end
    ...
    it "is invalid without prefecture_id" do
      ...
      send_information.valid?
      expect(send_information.errors[:prefecture_id]).to include("を入力してください")
    end
    ...
    it "is invalid without house_number" do
      ...
      send_information.valid?
      expect(send_information.errors[:house_number]).to include("を入力してください")
    end
